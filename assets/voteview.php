...
<span class="insert-profile">
	<div class="row-fluid">
		<div class="span12">
			...
			<?php if($image_info['category'] == 'art'){?>
				<div class="row-fluid">
					<div class="span12 subcategory-container-outer-art">
						<?php for($i = 0; $i <= 3; $i++){ ?>
							
							<div class="subcategory-container-art">
								<a href="#" class="art-sub" data-subcategory="<?php echo $DBart[$i]; ?>" rel="tooltip" title="<?php echo $subcategoriesart[$i];?>">
									<img src="<?php echo $subcategorylinks[$i]; ?>"/></a>
							</div>
				...
				<div class="span12">
					<div class="span3" id="leftvotecolumn">
						...
						<div class="row-fluid top10-bar" id="top10-bar-sort">
							<div class="span12">
								<button class="btn btn-small btn-info toplist active done"><strong><small>Toplists</small></strong></button>
								<button class="btn btn-small btn-info most-commented" data-sub="0"><strong><small>Comments</small></strong></button>
								<button class="btn btn-small btn-info most-favourite" data-sub="0"><strong><small>Favourites</small></strong></button>
							...
							<div class="row-fluid" id="top10-list">
								<div class="span12">
										...
										<?php if($_SESSION['subcategory']){?>
											...
											<?php for($i = 0; $i <= 9; $i++){?>
												<div class="toplist-img-container nailthumbs">
													<a href="#"><img src="<?php echo $filepaths[1][$i]; ?>" class="toplistimages-sub"/></a>
												</div>
											<?php }?>
										...
										<?php } else {?>
											...
											<?php for($i = 0; $i <= 9; $i++){?>
												<div class="toplist-img-container nailthumbs">
													<a href="#"><img src="<?php echo $filepaths[1][$i]; ?>" class="toplistimages"/></a>
												</div>
											<?php }?>
				...
				<div class="row-fluid" id="rate-image-container-outer">			<!-- image row -->
					<div class="span12">
						<div class="row-fluid" id="rate-image-container-inner">
							<div class="span12">
								<a href="#" id="large-image-rated"><img class="mainimage" src="<?php echo $random_image; ?>" data-category="<?php echo $image_info['category']; ?>" data-subcategory="<?php echo $image_info['subcategory']; ?>" 
									...
									data-size="<?php echo $image_info['size']; ?>" data-bandwidth="<?php echo $image_info['bandwidth']; ?>" data-user_id="<?php echo $image_info['user_id']; ?>"/></a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="span12">
							<div class="row-fluid" id="voteimage-info-inner">
								...
								<?php } else {?>
									...
									<small id="comment-font-size"><a href="#" class="userlink" data-userx_id="<?php echo $image_info['user_id']; ?>"><strong><?php echo $image_info['username']; ?></strong></a>
								...
								<div class="span2">
									&nbsp;<a href="#" id="large-image-rated" class="btn btn-small btn-info voteview-options-design" rel="tooltip" title="Resize full"><i class="icon-resize-full icon-white"></i></a>
								</div>
												...
												<div class="span12" id="comment">
													...
													<div class="span1 reply-indicator">
														...
														<?php if($imagecomments[0][$i]['has_replies'] >= 1){?>
															<a href="#" id="extend-comment<?php echo $imagecomments[0][$i]['commentid']; ?>" class="onclick" data-commentid="<?php echo $imagecomments[0][$i]['commentid']; ?>"><strong>+</strong></a>
														<?php }?>
													...
													<div class="span11" id="comment-inner">
														...
														<?php if($imagecomments[0][$i]['display_state'] == 0){
															...
															<?php } else {?>
																	...
																	<small id="comment-font-size"><a href="#" class="userlink" data-userx_id="<?php echo $imagecomments[0][$i][2]; ?>"><strong><?php echo $imagecomments[0][$i]['username']; ?></strong></a>
														...
														<b class="<?php echo $imagecomments[0][$i]['commentid']; ?>like">
															<a href="#" class="likecomment" id="likecomment" data-commentid="<?php echo $imagecomments[0][$i]['commentid']; ?>" data-user_id="<?php echo $imagecomments[0][$i][2]; ?>"><i class="icon-thumbs-up"></i></a>
															<a href="#" class="dislikecomment" id="dislikecomment" data-commentid="<?php echo $imagecomments[0][$i]['commentid']; ?>" data-user_id="<?php echo $imagecomments[0][$i][2]; ?>"><i class="icon-thumbs-down"></i></a>
														</b>
														...
														<?php } 
															 ...
															 if($_SESSION['user_id'] == $imagecomments[0][$i][2]){?>
																...
																<a href="#" class="remove-comment" data-commentid="<?php echo $imagecomments[0][$i]['commentid'];?>"><small>remove</small></a>
																	...
																	<a href="#" class="show-hide-reply-comment" data-commentid="<?php echo $imagecomments[0][$i]['commentid']; ?>"><small>reply</small></a>
																	<a href="#" class="hide-comment" data-commentid="<?php echo $imagecomments[0][$i]['commentid']; ?>"><small>hide</small></a>
																	...
																	<a href="#" class="show-hide-reply-comment" data-commentid="<?php echo $imagecomments[0][$i]['commentid']; ?>"><small>reply</small></a>
																	<a href="#" class="report-comment" data-commentid="<?php echo $imagecomments[0][$i]['commentid']; ?>"><small>report</small></a>
									...
									<div class="row-fluid">
										...
										<div class="span1 reply-indicator">
											<?php if($imagecomments[1][$i]['has_replies'] >= 1){?>
												<a href="#" id="extend-comment<?php echo $imagecomments[1][$i]['commentid']; ?>" class="onclick" data-commentid="<?php echo $imagecomments[1][$i]['commentid']; ?>"><strong>+</strong></a>
											<?php }?>
										</div>
										...
										<?php if($imagecomments[1][$i]['display_state'] == 0){
											...
											<?php } else {?>
												...
												<small id="comment-font-size"><a href="#" class="userlink" data-userx_id="<?php echo $imagecomments[1][$i][2]; ?>"><strong><?php echo $imagecomments[1][$i]['username']; ?></strong></a>
											...
											<?php if(($_SESSION['user_id'] != $imagecomments[1][$i]['user_id']) && ($imagecomments[1][$i]['is_reported'] < 50) && ($_SESSION['user_id'] != $imagecomments[1][$i][2])){?>
													...
													<b class="<?php echo $imagecomments[1][$i]['commentid']; ?>like">
														<a href="#" class="likecomment" id="likecomment" data-commentid="<?php echo $imagecomments[1][$i]['commentid']; ?>"><i class="icon-thumbs-up"></i></a>
														<a href="#" class="dislikecomment" id="dislikecomment" data-commentid="<?php echo $imagecomments[1][$i]['commentid']; ?>"><i class="icon-thumbs-down"></i></a>
													</b>
														
											<?php }  if($_SESSION['user_id'] == $imagecomments[1][$i][2]){?>
																
													<a href="#" class="remove-comment" data-commentid="<?php echo $imagecomments[1][$i]['commentid'];?>"><small>remove</small></a>
									
															<?php if($imagecomments[1][$i]['is_reported'] >= 1){?>
														
																<a href="#" class="show-reported-comment reported-message<?php echo $imagecomments[1][$i]['commentid']; ?>" data-commentid="<?php echo $imagecomments[1][$i]['commentid']; ?>"><small>show</small></a>
										
																<span class="hide-reported hide-reported<?php echo $imagecomments[1][$i]['commentid'];?>">
												
																<a href="#" class="hide-comment" data-commentid="<?php echo $imagecomments[1][$i]['commentid']; ?>"><small>hide</small></a>
															...
															<?php }} else { 
																...
																if($imagecomments[1][$i]['is_reported'] >= 1){?>
																	...
																	<a href="#" class="show-hide-reply-comment" data-commentid="<?php echo $imagecomments[1][$i]['commentid']; ?>" data-user_id="<?php echo $imagecomments[1][$i][2]; ?>"><small>reply</small></a>
																	<a href="#" class="hide-comment" data-commentid="<?php echo $imagecomments[1][$i]['commentid']; ?>" data-user_id="<?php echo $imagecomments[1][$i][2]; ?>"><small>hide</small></a>
															
																	</span>
													
																<?php } else {?>
								
																	<a href="#" class="show-hide-reply-comment" data-commentid="<?php echo $imagecomments[1][$i]['commentid']; ?>"><small>reply</small></a>
																	<a href="#" class="report-comment" data-commentid="<?php echo $imagecomments[1][$i]['commentid']; ?>"><small>report</small></a>
								...
								<div class="pagination pagination-mini pagination-centered">
									<ul class="comment-nav">
										<?php for($i = 1; $i <= ($comment_pages + 1); $i++){ ?>
											<li class="<?php if($i == 1){?>active<?php }?>"><a href="#" class="next-page<?php if($i == 1){?> done<?php } ?>" data-current_page="<?php echo $i?>"><?php echo $i; ?></a></li>
										<?php } ?>
									</ul>
								</div>
							<?php }}?>
