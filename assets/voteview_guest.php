				...
				<div class="span12">
					<div class="span3" id="leftvotecolumn">
						...
						<div class="row-fluid top10-bar" id="top10-bar-sort">
							<div class="span12">
								<button class="btn btn-small btn-info toplist active"><strong><small>Toplists</small></strong></button>
				...
				<div class="row-fluid" id="rate-image-container-outer">			<!-- image row -->
					<div class="span12">
						<div class="row-fluid" id="rate-image-container-inner">
							<div class="span12">
								<img class="mainimage" src="<?php echo $random_image; ?>" data-category="<?php echo $image_info['category']; ?>" data-subcategory="<?php echo $image_info['subcategory']; ?>" 
									...
									data-size="<?php echo $image_info['size']; ?>" data-bandwidth="<?php echo $image_info['bandwidth']; ?>" data-user_id="<?php echo $image_info['user_id']; ?>"/>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="span12">
							<div class="row-fluid" id="voteimage-info-inner">
								...
								Uploaded by: 
									...
									<strong>&nbsp;&nbsp;&nbsp;&nbsp; http://doostr.com/?i=<?php echo $image_info['image_id']; ?></strong>
