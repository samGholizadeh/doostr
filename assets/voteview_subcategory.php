					...
					<div class="span3" id="leftvotecolumn">
						...
						<div class="row-fluid top10-bar" id="top10-bar-sort">
							<div class="span12">
								...
								<button class="btn btn-small btn-info most-commented" data-sub="1"><strong><small>Comments</small></strong></button>
								<button class="btn btn-small btn-info most-favourite" data-sub="1"><strong><small>Favourites</small></strong></button>
