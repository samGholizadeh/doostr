<div class=row-fluid">
	<div class="span12" id="rightvotecolumn-modal"> <!-- Left column in voteview begins here -->
		
		<div class="row-fluid">
			<div class="span12">
			
							<!-- image row -->
				<div class="span6" id="rate-image-container-outer-modal">
					<div class="row-fluid" id="rate-image-container-inner">
						<div class="span12">
						
							<img id="rated-modal-image-border" class="mainimage<?php echo $image_info['image_id']; ?>" src="<?php echo $random_image; ?>" data-category="<?php echo $image_info['category']; ?>" data-subcategory="<?php echo $image_info['subcategory']; ?>" 
								data-votes="<?php echo $image_info['numvotes'];?>" data-totalscore="<?php echo $image_info['totalscore']; ?>" 
								data-size="<?php echo $image_info['size']; ?>" data-bandwidth="<?php echo $image_info['bandwidth']; ?>" data-image_id="<?php echo $image_info['image_id']; ?>"/>
						...
						<div class="span12">
							<div class="row-fluid" id="voteimage-info-inner">
								...
								<?php if($_SESSION['user_id'] == $image_info['user_id']){?>
									...
									<small id="comment-font-size"><strong><?php echo $image_info['username']; ?></strong></a>
			...
			<div class="span12">
				...
				<div class="row-fluid" id="vote-numbers-result">						
					<div class="span12">
						...
						<div class="span6 button-group rate-done<?php echo $image_info['image_id']; ?>">
							<div class="btn-group ">
										<a href="#" class="btn btn-mini btn-info modal-rate" data-image_id="<?php echo $image_info['image_id']; ?>" data-votevalue="1"><strong>1</strong></a>
										<a href="#" class="btn btn-mini btn-info modal-rate" data-image_id="<?php echo $image_info['image_id']; ?>" data-votevalue="2"><strong>2</strong></a>
										<a href="#" class="btn btn-mini btn-info modal-rate" data-image_id="<?php echo $image_info['image_id']; ?>" data-votevalue="3"><strong>3</strong></a>
										<a href="#" class="btn btn-mini btn-info modal-rate" data-image_id="<?php echo $image_info['image_id']; ?>" data-votevalue="4"><strong>4</strong></a>
										<a href="#" class="btn btn-mini btn-info modal-rate" data-image_id="<?php echo $image_info['image_id']; ?>" data-votevalue="5"><strong>5</strong></a>
										<a href="#" class="btn btn-mini btn-info modal-rate" data-image_id="<?php echo $image_info['image_id']; ?>" data-votevalue="6"><strong>6</strong></a>
										<a href="#" class="btn btn-mini btn-info modal-rate" data-image_id="<?php echo $image_info['image_id']; ?>" data-votevalue="7"><strong>7</strong></a>
										<a href="#" class="btn btn-mini btn-info modal-rate" data-image_id="<?php echo $image_info['image_id']; ?>" data-votevalue="8"><strong>8</strong></a>
										<a href="#" class="btn btn-mini btn-info modal-rate" data-image_id="<?php echo $image_info['image_id']; ?>" data-votevalue="9"><strong>9</strong></a>
										<a href="#" class="btn btn-mini btn-info modal-rate" data-image_id="<?php echo $image_info['image_id']; ?>" data-votevalue="10"><strong>10</strong></a>
							</div>
						</div>
						
						<div class="span3" id="vote-result-modal">
							<p>Votes: <strong id="vote-increment<?php echo $image_info['image_id']; ?>"><?php echo $image_info['numvotes']; ?></strong> Avg.&nbsp<strong id="display-average<?php echo $image_info['image_id']; ?>"></strong></p>
						</div>
						
						<div class="span1">
							<button class="btn btn-mini btn-info fav-img-modal <?php if(($favourite[0] >= 1) || ($_SESSION['user_id'] == $image_info['user_id'])){ ?>active done<?php }?>" data-image_id="<?php echo $image_info['image_id']; ?>"><strong>Fav.</strong></button>
						</div>
				...
				<div class="row-fluid">
					<div class="span12" id="vote-comment-container-modal">
					
						<div class="span10">
							<textarea class="modal-rate-comment<?php echo $image_info['image_id']; ?>" placeholder="Comment..."></textarea>
						</div>
						...
						<div class="span1" id="profile-submit-counter-container">
							...
							<div class="row-fluid" id="submit-button-container">
								<div class="span12">
									<button class="btn btn-mini btn-info" id="submit-comment-voteimg-modal" data-image_id="<?php echo $image_info['image_id']; ?>"><strong>Submit</strong></button>
								</div>
							</div>
							
							<div class="row-fluid">
								<div class="span12">
									<strong><span id="comment-counter<?php echo $image_info['image_id']; ?>"></span></strong>
								</div>
							</div>
							
							<script type="text/javascript">
							$('.modal-rate-comment<?php echo $image_info['image_id']; ?>').limit('140', '#comment-counter<?php echo $image_info['image_id']; ?>');
							</script>
				...
				<div class="row-fluid comment-container-outer">
					<div class="span12">
						...
						<span id="vote-comment-template<?php echo $image_info['image_id']; ?>">
						
								<h3 id="remove-when-comment<?php echo $image_info['image_id']; ?>">No comments available</h3>
												...
												<div class="span12" id="comment">
													...
													<div class="span1 reply-indicator">
														...
														<?php if($imagecomments[0][$i]['has_replies'] >= 1){?>
															<a href="javascript:void(0);" id="extend-comment<?php echo $imagecomments[0][$i]['commentid']; ?>" class="onclick" data-commentid="<?php echo $imagecomments[0][$i]['commentid']; ?>" data-image_id="<?php echo $imagecomments[0][$i]['image_id']; ?>"><strong>+</strong></a>
														<?php }?>
													...
													<div class="span11" id="comment-inner">
														...
														<?php if($imagecomments[0][$i]['display_state'] == 0){
															...
															if($_SESSION['user_id'] == $imagecomments[0][$i][2]){?>
																...
																<small id="comment-font-size"><strong><?php echo $imagecomments[0][$i]['username']; ?></strong>
															...
															<span class="reply-comment" id="<?php echo $imagecomments[0][$i]['commentid']; ?>">
																<div class="row-fluid">
																	<div class="span12">
																		...
																		<button class="btn btn-mini submit-reply-button-modal" data-commentid="<?php echo $imagecomments[0][$i]['commentid']; ?>" data-image_id="<?php echo $imagecomments[0][$i]['image_id']; ?>"><strong>Submit</strong></button>
							...
							<span class="page5">
								...
								<?php for($i = 0; $i <= (count($imagecomments[1]) - 1); $i++){
									...
									if(($imagecomments[0][0]['commentid'] == $imagecomments[1][$i]['commentid']) || ($imagecomments[0][1]['commentid'] == $imagecomments[1][$i]['commentid']) || ($imagecomments[0][2]['commentid'] == $imagecomments[1][$i]['commentid']) || ($imagecomments[1][$i]['display_state'] == 1)){ continue; } else { ?>
									...
									<div class="row-fluid">
										...
										<?php if($imagecomments[1][$i]['display_state'] == 0){
											...
											if($_SESSION['user_id'] == $imagecomments[1][$i][2]){?>
												...
												<small id="comment-font-size"><strong><?php echo $imagecomments[1][$i]['username']; ?></strong>
											...
											<?php if(($_SESSION['user_id'] != $imagecomments[1][$i]['user_id']) && ($imagecomments[1][$i]['is_reported'] < 50) && ($_SESSION['user_id'] != $imagecomments[1][$i][2])){?>
													...
													<div class="row-fluid">
														<div class="span12">
															...
															<textarea class="<?php echo $imagecomments[1][$i]['commentid']; ?>" id="reply-textarea" placeholder="Comment..."></textarea><br>
																<button class="btn btn-mini submit-reply-button-modal" data-commentid="<?php echo $imagecomments[1][$i]['commentid']; ?>" data-image_id="<?php echo $imagecomments[1][$i]['image_id']; ?>"><strong>Submit</strong></button>
							...
							for($i = 2; $i <= ($comment_pages + 1); $i++){?>
								...
								<span class="page5">
									<span class="modal-rate-comments-page<?php echo $image_info['image_id']; echo $i;?>">
								...
								<div class="pagination pagination-mini pagination-centered">
									<ul class="comment-nav">
										<?php for($i = 1; $i <= ($comment_pages + 1); $i++){ ?>
											<li class="<?php if($i == 1){?>active<?php }?>"><a href="javascript:void(0);" class="next-page-modal-rate<?php if($i == 1){?> done<?php } ?>" data-image_id="<?php echo $image_info['image_id']; ?>" data-current_page="<?php echo $i?>"><?php echo $i; ?></a></li>
										<?php } ?>
									</ul>
								</div>
							<?php }}?>
