      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
            	<li><a href="?a=meme"><strong>Meme</strong></a></li>
            	<li><a href="?a=awww"><strong>Awww</strong></a></li>
        	  	  <li><a href="?a=gif"><strong>Gif</strong></a></li>
        	  	  <li><a href="?a=wtf"><strong>WTF</strong></a></li>
        	  	  <li><a href="?a=art"><strong>Art</strong></a></li>
        	  	  <li><a href="?a=gaming"><strong>Gaming</strong></a></li>
        	      <li><a href="?a=other"><strong>Other</strong></a></li>
          ...
          <ul class="nav pull-right">
          		...
          		<span id="insert-friend-indicator">
          			...
          			<?php  if(empty($new_friend[0])){
          					...
          					echo $new_friend[0]; ?>&nbsp<i class="icon-user icon-white"></i>
          		...
          		<span id="insert-message-indicator">
          			...
          			<?php if(empty($new_messages[0])){
          				...
          				echo $new_messages[0];?>&nbsp<i class="icon-envelope icon-white"></i>
         		 ...
         		 <span id="after-login2">
         		  	<a href="#signin-register" class="btn btn-small btn-info" data-toggle="modal"><strong>Sign in&nbsp/&nbsp&nbspRegister</strong></a>
         		 </span>
