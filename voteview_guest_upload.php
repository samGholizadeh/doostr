					...
					<div class="row-fluid" id="rate-image-container-outer">			<!-- image row -->
						<div class="span12">
							<div class="row-fluid" id="rate-image-container-inner">
								<div class="span12">
									<a href="#" id="large-image-guest" data-filename="<?php echo $_SESSION[$upload_id][0]; ?>"><img class="mainimage" src="g/files/<?php echo $_SESSION[$upload_id][0]; ?>"></a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="span12">
							...
							<div class="span12">
								<div class="row-fluid" id="voteimage-info-inner">
									...
									<div class="span2">
										&nbsp;<a href="#" id="large-image-guest" class="btn btn-small btn-info voteview-options-design" rel="tooltip" title="Resize full" data-filename="<?php echo $_SESSION[$upload_id][0]; ?>"><i class="icon-resize-full icon-white" ></i></a>
									</div>
