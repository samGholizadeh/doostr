	<div class="row-fluid" id="rate-image-container-outer">			<!-- image row -->
		<div class="span12">
			<div class="row-fluid" id="rate-image-container-inner">
				<div class="span12">
					<a href="#" id="large-image-guest"><img class="mainimage" src="g/files/<?php echo $_SESSION[$upload_id][$current_page]; ?>"></a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="span12">
				<div class="row-fluid" id="voteimage-info-inner">
					<div class="span10">
						...
						<span class="the-dot"> &#8226;</span><strong> http://doostr.com/?z=<?php echo $_SESSION[$upload_id][$current_page]; ?></strong>
							
					</div>
					
					<div class="span2">
						&nbsp;<a href="#" id="large-image-guest" class="btn btn-small btn-info voteview-options-design" rel="tooltip" title="Resize full" data-filename="<?php echo $_SESSION[$upload_id][$current_page]; ?>"><i class="icon-resize-full icon-white"></i></a>
					</div>
